...
void RELAY_PROCESS(uint8_t x)
{
    switch(x)
    {
        case 0:
        {
            do { LATCbits.LATC4 = 1; } while(0);do { LATCbits.LATC3 = 1; } while(0);do { LATCbits.LATC6 = 1; } while(0);
            break;
        }
        case 1:
        {
            do { LATCbits.LATC4 = 1; } while(0);do { LATCbits.LATC3 = 1; } while(0);do { LATCbits.LATC6 = 0; } while(0);
            break;
        }
        case 2:
        {
            do { LATCbits.LATC4 = 1; } while(0);do { LATCbits.LATC3 = 0; } while(0);do { LATCbits.LATC6 = 1; } while(0);
            break;
        }
        case 3:
        {
            do { LATCbits.LATC4 = 1; } while(0);do { LATCbits.LATC3 = 0; } while(0);do { LATCbits.LATC6 = 0; } while(0);
            break;
        }
        case 4:
        {
            do { LATCbits.LATC4 = 0; } while(0);do { LATCbits.LATC3 = 1; } while(0);do { LATCbits.LATC6 = 1; } while(0);
            break;
        }
        case 5:
        {
            do { LATCbits.LATC4 = 0; } while(0);do { LATCbits.LATC3 = 1; } while(0);do { LATCbits.LATC6 = 0; } while(0);
            break;
        }
        case 6:
        {
            do { LATCbits.LATC4 = 0; } while(0);do { LATCbits.LATC3 = 0; } while(0);do { LATCbits.LATC6 = 1; } while(0);
            break;
        }
        case 7:
        {
            do { LATCbits.LATC4 = 0; } while(0);do { LATCbits.LATC3 = 0; } while(0);do { LATCbits.LATC6 = 0; } while(0);
            break;
        }
    }
}
